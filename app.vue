  ...
  <div>
    ...
    <div class="drawer">
      ...
      <div class="drawer-content">
        <Navbar />
          <div class="w-11/12 content-center mx-auto mb-10 transition-colors ease-linear shadow-md">
            ...
            <div class="flex bg-gray-100 dark:bg-gray-700 border-t-0 w-full rounded-b-lg h-auto">
              <NuxtPage />
            </div>
          </div>
