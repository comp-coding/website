<template>
  <div class="navbar bg-base-100">
    ...
    <!-- left -->
    <div class="flex-none">
      <label for="my-drawer" class="btn btn-square btn-ghost drawer-button"><svg xmlns="http://www.w3.org/2000/svg"
          fill="none" viewBox="0 0 24 24" class="inline-block w-10 h-10 stroke-current">
    ...
    <div class="flex-none space-x-3">
      <NuxtLink to="https://github.com/kgv-club-dev" target="_blank"><img src="/Github.png" class="w-10 h-10">
      </NuxtLink>
