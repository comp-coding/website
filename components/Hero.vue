    ...
    <div class="hero min-h-screen bg-base-200">
        <div class="hero-content flex-col lg:flex-row">
            ...
            <div>
                ...
                <p class="py-6">This club is supported by KGV CAS and Hack Club, a nonprofit organisation that provides us with many resources. This club is expected to start shortly after Challenge Week 2022, and signups will be available on Lionel soon. The website is still under development.</p>
